...
import { performSearch, type SearchResult } from '../utils/search.ts';
                ...
                <div className="flex items-center gap-4">
                    ...
                    {currentProjectId && location.pathname !== '/' && (
                        <nav className="hidden md:flex items-center gap-6 font-serif">
                            ...
                            <NavLink to="/catalogue" className={({ isActive }) => `transition-colors ${isActive ? 'text-primary font-bold' : 'text-muted-foreground hover:text-accent'}`}>
                                Catalogue
                            </NavLink>
